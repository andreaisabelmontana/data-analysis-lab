// The numerical cores below — distribution tails, the seeded RNG, and the
// sample summaries — live in framework-free, tested ES modules under ./lib so
// they can be unit-tested with `node --test`. This file imports them and keeps
// only the DOM wiring and per-demo rendering.
import {
  normPdf, normCdf, normInv,
  chiSqTail, tTailTwo, tCdf, fTail, tInv, tPdf,
} from './lib/distributions.js';
import { randn, randExp, randGamma } from './lib/random.js';
import { mean, variance } from './lib/summary.js';
...
// The shared numerical cores (normal/t/chi-square/F tails, the RNG, and the
// sample summaries `mean`/`variance`) are imported at the top of this file
// from ./lib — see distributions.js, random.js and summary.js.
